    ...
    $(function () {
        ...
        function bindFormatEvents() {
            $(".removeformat").off('click').on('click', function () {
                ...
                $(this).closest('.formatsdiv').html(formats);
            ...
            $(".addformatitem").off('click').on('click', function () {
                ...
                var format;
                format = $(this).attr('cformat');
                if(format) {
                    format = {type:"class",value:format};
                } else {
                    format = $(this).attr('nformat');
                    if(format) {
                        format = {type:"number",value:format};
                    } else {
                        format = $(this).attr('dformat');
                        if(format) {
                            format = {type:"date",value:format};
                        } else {
                            format = $(this).attr('tformat');
                            if(format=='addtext'){
                                ...
                                if (textstring == null || textstring == "") {
                                    ...
                                    format = {type:"addtext",value:textstring};
                                }
                            } 
                        }
                    }
            ...
            $(".addformatlink").off('click').on('click', function () {
                ...
                $('#formatSelectForm').position({my: 'left top', at:'right bottom', of:$(this)});
                $('#formatSelectForm .dropdown .dropdown-menu.multi-level').show();
                return false;
            });
